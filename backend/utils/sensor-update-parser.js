...
const SENSOR_ALIAS_MAP = {
    ...
    ec_substrate: { type: 'terreno', subtype: 'ec_substrate', unit: 'dS/m', name: 'EC Substrat' },
    ec_root: { type: 'terreno', subtype: 'ec_root', unit: 'dS/m', name: 'EC Racinaire' },
    ...
    substrate_ec: { type: 'terreno', subtype: 'ec_substrate', unit: 'dS/m', name: 'EC Substrat' },
    bulk_ec: { type: 'terreno', subtype: 'ec_substrate', unit: 'dS/m', name: 'EC Substrat' },
    substrate_bulk_ec: { type: 'terreno', subtype: 'ec_substrate', unit: 'dS/m', name: 'EC Substrat' },
    root_ec: { type: 'terreno', subtype: 'ec_root', unit: 'dS/m', name: 'EC Racinaire' },
    pore_ec: { type: 'terreno', subtype: 'ec_root', unit: 'dS/m', name: 'EC Racinaire' },
    substrate_pore_ec: { type: 'terreno', subtype: 'ec_root', unit: 'dS/m', name: 'EC Racinaire' },
