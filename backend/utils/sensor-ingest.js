...
const CANONICAL_SENSOR_PROFILES = {
    ...
    ec_substrate: { type: 'terreno', subtype: 'ec_substrate', name: 'EC Substrat', unit: 'dS/m' },
    ec_root: { type: 'terreno', subtype: 'ec_root', name: 'EC Racinaire', unit: 'dS/m' },
...
const TYPE_ALIAS_TO_SUBTYPE = {
    ...
    terreno: {
        ...
        ec_substrate: 'ec_substrate',
        substrate_ec: 'ec_substrate',
        bulk_ec: 'ec_substrate',
        substrate_bulk_ec: 'ec_substrate',
        ec_root: 'ec_root',
        root_ec: 'ec_root',
        pore_ec: 'ec_root',
        substrate_pore_ec: 'ec_root',
