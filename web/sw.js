...
const ASSETS_TO_CACHE = [
    ...
    './assets/js/analytics-loader.js?v=1.1.35',
    ...
    './icons/icon-192.png',
    './icons/icon-512.png',
    './vendor/tailwind/tailwindcss-cdn.js?v=1.1.35',
    './vendor/leaflet/1.9.4/leaflet.css?v=1.1.35',
    './vendor/leaflet/1.9.4/leaflet.js?v=1.1.35',
    ...
    './vendor/jspdf/2.5.1/jspdf.umd.min.js?v=1.1.35'
];
