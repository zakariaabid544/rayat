...
const CACHE_VERSION = '1.1.46'; // RAYAT-FIX
...
const ASSETS_TO_CACHE = [
    ...
    './favicon-32.png',
    './favicon.ico',
    './assets/css/public.css?v=1.1.46', // RAYAT-FIX
    './assets/js/analytics-loader.js?v=1.1.46',
    './assets/js/public.js?v=1.1.46', // RAYAT-FIX
