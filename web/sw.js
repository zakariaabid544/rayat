...
const CACHE_VERSION = '1.1.36'; // RAYAT-FIX
...
const ASSETS_TO_CACHE = [
    ...
    './favicon-32.png',
    './favicon.ico',
    './assets/css/public.css?v=1.1.36', // RAYAT-FIX
    './assets/js/analytics-loader.js?v=1.1.36',
    './assets/js/public.js?v=1.1.36', // RAYAT-FIX
    ...
    './icons/icon-192.png',
    './icons/icon-512.png',
    './vendor/tailwind/tailwindcss-cdn.js?v=1.1.36',
    './vendor/leaflet/1.9.4/leaflet.css?v=1.1.36',
    './vendor/leaflet/1.9.4/leaflet.js?v=1.1.36',
    ...
    './vendor/jspdf/2.5.1/jspdf.umd.min.js?v=1.1.36'
];
